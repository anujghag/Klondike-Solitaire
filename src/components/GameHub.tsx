...
export const GameHub: React.FC<GameHubProps> = ({
  ...
  onPlaySevens, onPlayBluff, onPlayMendikot,
}) => {
  ...
  const totalWins = klondikeWins + (['spider', 'freecell', 'sevens', 'bluff', 'mendikot'] as GameId[])
    .reduce((a, id) => a + (multiStats[id]?.wins ?? 0), 0);
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center mb-8 sm:mb-10">
            ...
            <p className="text-white/60 text-sm sm:text-base">
              Six games. Zero ads. Your table, your rules.
            </p>
